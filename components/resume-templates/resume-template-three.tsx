...
const ResumeTemplateThree: React.FC<ResumeTemplateProps> = ({
  resumeData,
  colorIndex = 0,
  containerWidth,
}) => {
  ...
  return (
    ...
    >
      <div className="grid grid-cols-12 bg-white shadow-lg">
        <div className="col-span-12 flex items-start justify-between px-5 py-2">
          <div className="flex flex-col items-start">
            <h1 className="text-4xl font-medium">Name</h1>
            <h1 className="text-xl font-medium">Role</h1>
          </div>
          {resumeData.profile ? (
            <p className="text-xs mt-2 text-justify w-1/2">
              {resumeData.profile}
            </p>
          ) : (
        ...
        {/* LEFT SECTION */}
        <div
          className="col-span-4 flex flex-col items-center p-4"
        ...
        >
          ...
          {/* CONTACT */}
          <SectionMain title="Contact" color={primaryColor}>
          ...
          {/* LANGUAGES */}
          <SectionMain title="LANGUAGES" color={primaryColor}>
