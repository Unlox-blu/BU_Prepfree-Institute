  ...
  return (
    ...
    >
      <div className="grid grid-cols-12 bg-white shadow-lg">
        {/* LEFT SECTION */}
        <div
          className="col-span-4 flex flex-col items-center p-2 text-white"
          style={{ backgroundColor: primaryColor }}
        >
          {/* IMAGE */}
          <div className="w-32 h-32 flex items-center justify-center rounded-full overflow-hidden bg-gray-300 mt-4">
            {resumeData.image ? (
              <img
          ...
          {/* CONTACT */}
          <h1 className="w-full text-md mt-2 font-medium border-b border-white">
            CONTACT
          </h1>
